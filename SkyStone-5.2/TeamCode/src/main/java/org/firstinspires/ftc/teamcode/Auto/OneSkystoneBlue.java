...
@Autonomous (name = "OneSkystoneBlue")

public class OneSkystoneBlue extends OpMode {
    ...
    enum State {
        Straighten, Detection, p1Straighten, p1ForwardIntake, p1Reverse, p1angleIntake, p1ForwardToDeliver, p1Dispense, p1Park, p2Straighten, p2ForwardIntake, p2Reverse, p2angleIntake, p2ForwardToDeliver, p2Dispense, p2Park, p3Straighten, p3ForwardIntake, p3Reverse, p3angleIntake, p3ForwardToDeliver, p3Dispense, p3Park, Stop, MoveForward, p3StrafeRightbefore, p2StrafeRightbefore, p1ToCase, p2ToCase, p3ToCase, p3FailSafe, p1StrafeRightbefore
    ...
    public void loop() {
        ...
        switch (state){
            ...
            case Detection:
                    if (tfod != null) {
                        ...
                        if (count == 1 && skystoneFound){
                            ...
                            positio = 2;
                            state = State.p2StrafeRightbefore;
                        }
                        else if (count == 3 && skystoneFound){
                            positio = 3;
                            state = State.p3FailSafe;
                        }
                    }
                    break;
            ...
            case p1StrafeRightbefore:
                robot.StrafeRight(1, 13);
                if (robot.StrafeDriveDone(13)) {
            ...
            case p1Straighten:
                ...
                if (gyroangle >= 26 && gyroangle <= 34 && CurrentTime >= .25){
            ...
            case p1angleIntake:
                ...
                if (gyroangle >= 78 && gyroangle <= 82 && CurrentTime >= .5){
            ...
            case p2StrafeRightbefore:
                robot.StrafeRight(1, 8);
            ...
            case p3FailSafe:
                robot.StrafeLeft(1, 46);
                if  (robot.StrafeDriveDone(46)) {
                    state = State.Stop;
                    Reset();
                }
                break;

            case p3StrafeRightbefore:
                robot.StrafeRight(1, 14);
                if (robot.StrafeDriveDone(14)) {
