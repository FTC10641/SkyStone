...
@Autonomous(name = "WallFoundationRed")
...
public class FoundRed extends OpMode {
    ...
    enum State {
        DriveBackwards2, Turn, DriveForwards, StrafeRight, StrafeLeft,
        DriveBackwards, DriveForwards2, Foundation, Stop, Straighten, StrafeRight1, DriveBackwards3, StraightenToGrab, StrafeLeft2, FinalStraighten,
...
//                break;
            ...
            case Turn:
                ...
                if (gyroangle <= -86 && gyroangle >= -94 && CurrentTime >= .25) {
                    robot.ServosUp();
