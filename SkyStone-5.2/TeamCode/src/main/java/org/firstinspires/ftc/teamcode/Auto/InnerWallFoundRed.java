...
@Autonomous(name = "InnerFoundRed")

public class InnerWallFoundRed extends OpMode {
    ...
    enum State {
        ...
        DriveBackwards, DriveForwards2, Foundation, Stop, Straighten, StrafeRight1, DriveBackwards3, StraightenToGrab,
